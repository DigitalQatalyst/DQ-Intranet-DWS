      ...
      <div className="container mx-auto px-4 py-2">
        <div className="flex flex-col sm:flex-row items-center">
          ...
          <div className="flex flex-wrap gap-2 sm:ml-auto">
            ...
            <Link to="/marketplace/services-center" className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${isActive('/marketplace/services-center') ? 'bg-blue-600 text-white' : 'bg-white text-blue-600 hover:bg-blue-50'}`}>
              Business Services
            </Link>
          </div>
        </div>
