...
export const SearchBar: React.FC<SearchBarProps> = ({
  ...
  return <div className="relative">
      <input
        type="text"
        className="block w-full pl-3 pr-10 py-3 text-sm border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
