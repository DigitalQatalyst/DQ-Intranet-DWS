...
function GuidelinePage() {
  ...
  const currentSlug = 'agile-working-guidelines'
          ...
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-2">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  <ChevronRightIcon size={16} className="text-gray-400" />
                  <span className="ml-1 text-gray-500 md:ml-2">Agile Working Guidelines</span>
                </div>
              </li>
            </ol>
          </nav>
        ...
        <div className="container mx-auto px-4 py-12 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3 bg-white rounded-lg shadow-sm p-8 md:p-12">
              <GuidelineSection id="principles" title="Principles">
                <ul className="list-disc list-inside space-y-2">
                  <li>Value outcomes over outputs</li>
                  <li>Short feedback loops</li>
                  <li>Transparent work and WIP limits</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="team-rhythms" title="Team Rhythms">
                <ul className="list-disc list-inside space-y-2">
                  <li>Daily stand-up (15 min)</li>
                  <li>Planning (every sprint)</li>
                  <li>Review & Retrospective (end of sprint)</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="cadence-health" title="Cadence Health">
                <ul className="list-disc list-inside space-y-2">
                  <li>Stable velocity within ±20%</li>
                  <li>No carry-over without explicit reason</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="collaboration-norms" title="Collaboration Norms">
                <ul className="list-disc list-inside space-y-2">
                  <li>Default to public channels</li>
                  <li>Decision logs and action owners</li>
                  <li>Async first; meeting hygiene</li>
                </ul>
              </GuidelineSection>
            </div>
