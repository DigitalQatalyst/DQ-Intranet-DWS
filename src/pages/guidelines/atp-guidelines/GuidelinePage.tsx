...
function GuidelinePage() {
  ...
  const currentSlug = 'atp-guidelines'
          ...
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="inline-flex items-center space-x-1 md:space-x-2">
              ...
              <li aria-current="page">
                <div className="flex items-center">
                  <ChevronRightIcon size={16} className="text-gray-400" />
                  <span className="ml-1 text-gray-500 md:ml-2">ATP Guidelines</span>
                </div>
              </li>
            </ol>
          </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3 bg-white rounded-lg shadow-sm p-8 md:p-12">
              <GuidelineSection id="overview" title="Overview">
                <p>
                  The Activity Tracking & Performance (ATP) process ensures work is visible, measurable, and linked to goals.
                </p>
              </GuidelineSection>

              <GuidelineSection id="objectives" title="Objectives">
                <ul className="list-disc list-inside space-y-2">
                  <li>Increase transparency of outcomes</li>
                  <li>Enable fair reviews and coaching</li>
                  <li>Feed promotion and rewards decisions</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="what-to-track" title="What to Track">
                <ul className="list-disc list-inside space-y-2">
                  <li><strong>Objectives</strong> (quarterly)</li>
                  <li><strong>Outcomes</strong> (bi-weekly summaries)</li>
                  <li><strong>Evidence</strong> (links, artifacts, metrics)</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="cadence" title="Cadence">
                <ul className="list-disc list-inside space-y-2">
                  <li><strong>Weekly:</strong> update personal log</li>
                  <li><strong>Bi-weekly:</strong> manager check-in</li>
                  <li><strong>Quarterly:</strong> formal review and calibration</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="tooling" title="Tooling">
                <ul className="list-disc list-inside space-y-2">
                  <li>Work items live in project tools (Jira/Azure DevOps)</li>
                  <li>Summaries captured in the ATP workspace</li>
                </ul>
              </GuidelineSection>

              <GuidelineSection id="ratings" title="Ratings">
                <p>
                  Signals: <strong>Exceeds / Meets / Building / Off-track</strong>
                </p>
              </GuidelineSection>

              <GuidelineSection id="governance" title="Governance">
                <p>
                  People Ops maintains the framework; managers ensure adherence.
                </p>
              </GuidelineSection>
            </div>
