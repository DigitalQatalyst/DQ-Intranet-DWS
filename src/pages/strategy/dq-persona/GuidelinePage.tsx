                          ...
                          <div className="pt-4">
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm text-gray-700">Purpose-driven approach</span>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                                  <svg className="w-2 h-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-sm text-gray-700">Perceptive decision making</span>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-4 h-4 rounded-full bg-green-500 flex items-center justify-center flex-shrink-0">
                                  <svg className="w-2 h-2 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="text-sm text-gray-700">Proactive leadership</span>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="border-t border-gray-200 pt-3 mt-4">
                    ...
                    <ul className="space-y-1 text-xs text-gray-600">
                      <li className="flex items-start">
                        ...
                        Understanding DQ Persona framework
                      </li>
                      <li className="flex items-start">
                        <span className="text-cyan-600 mr-1">•</span>
