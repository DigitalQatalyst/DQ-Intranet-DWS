...
function GuidelinePage() {
  const currentSlug = 'dq-agile-sos'
  const displayTitle = 'GHC 5 - Agile SoS (Governance)'
  ...
  const agileSosIntroBody = "Governance is the invisible architecture that enables agile teams to thrive. At DQ, our System of Scale (SoS) isn't about bureaucracy—it's about creating the right conditions for autonomy, alignment, and mastery at scale.\n\nThe Agile SoS competency articulates how we organize for agility without sacrificing coordination. It answers the fundamental question: \"How do we structure ourselves to deliver value efficiently while maintaining quality and compliance?\""
      ...
      try {
        ...
        if (!cancelled) {
          if (data) {
            ...
            setGuide(data)
            console.log('✅ [DQ-AGILE-SOS] Guide loaded:', {
              id: data.id,
              slug: data.slug,
              title: data.title,
                    ...
                    {activeTab === 'overview' && (
                      <div className="max-w-5xl mx-auto space-y-10">
                        ...
                        <div className="prose prose-base max-w-none text-gray-700 leading-relaxed">
                          <MarkdownRenderer body={agileSosIntroBody} />
                        </div>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-start gap-3">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                Agile governance principles: Learn how to govern agile teams at scale effectively.
                              </p>
                            </div>
                            <div className="flex items-start gap-3">
                              <div className="flex-shrink-0 mt-0.5">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                Scaled autonomy: Understand how to balance team independence with organizational alignment.
                              </p>
                            </div>
                            <div className="flex items-start gap-3">
                              <div className="flex-shrink-0 mt-0.5">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                Quality at scale: Maintain high standards while scaling agile practices across teams.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-blue-50 rounded-2xl p-8 border border-blue-100">
                          ...
                          <div className="space-y-5">
                            <div className="flex items-start gap-3">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                <span className="font-semibold">Scrum of Scrums:</span> Master the framework for coordinating multiple agile teams.
                              </p>
                            </div>
                            <div className="flex items-start gap-3">
                              <div className="flex-shrink-0 mt-1.5">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                <span className="font-semibold">Governance Practices:</span> Learn how to implement effective governance without bureaucracy.
                              </p>
                            </div>
                            <div className="flex items-start gap-3">
                              <div className="flex-shrink-0 mt-1.5">
                              ...
                              <p className="text-gray-700 text-base leading-relaxed">
                                <span className="font-semibold">Scaling Strategies:</span> Apply SoS principles to scale agile across your organization.
                              </p>
                            </div>
                          </div>
                        </div>
                    ...
                    {activeTab === 'storybook' && (
                      <GuidelineSection id="storybook" title="Explore Story Book">
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-xl font-semibold text-gray-900 mb-4">Agile SoS Story Book</h3>
                          <p className="text-gray-600 mb-8">
                            Explore the interactive story book that brings the DQ Agile SoS framework to life through engaging narratives and visual storytelling.
                          </p>
                          <button
                      ...
                      <GuidelineSection id="course" title="Course - Video Learning">
                        <div className="space-y-8">
                          <div className="text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-4">Agile SoS Video Course</h3>
                            <p className="text-gray-600 mb-8">
                              Deepen your understanding of the DQ Agile SoS framework through our comprehensive video learning modules.
                            </p>
                          </div>
                          ...
                          <div className="bg-white rounded-lg border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                              <div className="flex-1">
                                <h4 className="text-lg font-semibold text-gray-900 mb-1">DQ Agile SoS Course</h4>
                                <p className="text-sm text-gray-600">Complete learning module</p>
                              </div>
                              <a
                                href="https://dq-intranet-pykepfa4x-digitalqatalysts-projects.vercel.app/lms/ghc-course/lesson/828f2848-3489-4ee9-8169-7ba3d2c8c17a"
                                target="_blank"
