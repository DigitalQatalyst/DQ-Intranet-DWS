...
const sixXDElements: SixXDElement[] = [
  {
    ...
    highlight: '',
    supportingLines: [
      'Change starts when markets shift, customer behaviour evolves, and old value models stop working.',
      'Digital Economy helps teams understand why transformation is necessary — grounding decisions in real economic and customer signals.',
      'For new joiners: this explains why the work matters.',
    ],
    ...
    ctaText: 'View Courses → Learn one perspective at a time'
  },
  {
    ...
    highlight: '',
    supportingLines: [
      'DCO defines the future organisation — intelligent, adaptive, and able to sense, decide, and respond across people and systems.',
      'For new joiners: this shows the future state your work contributes toward.',
    ],
  ...
  },
  {
    ...
    subtitle: 'Products',
    question: 'What must be built?',
    narrative: '',
    highlight: '',
    supportingLines: [
      'Vision without foundations collapses.',
      'DBP focuses on the platforms and architectures that allow change to scale without breaking.',
      'For new joiners: this shows how today’s delivery fits into a long-term system.',
    ],
  ...
  },
  {
    ...
    subtitle: 'Products',
    question: 'How is change designed and delivered?',
    narrative: '',
    highlight: '',
    supportingLines: [
      'Transformation doesn’t succeed through isolated initiatives.',
      'DT2.0 introduces disciplined design, orchestration, and governance so change becomes repeatable and measurable.',
      'For new joiners: this explains how transformation actually happens at DQ.',
    ],
  ...
  },
  {
    ...
    highlight: '',
    supportingLines: [
      'Transformation lives or dies with people.',
      'DW:WS focuses on roles, skills, and digital environments so teams can deliver and sustain change confidently.',
      'For new joiners: this is where your role, tools, and ways of working come into focus.',
    ],
  ...
  },
  {
    ...
    subtitle: 'Products',
    question: 'When is value realised?',
    narrative: '',
    highlight: '',
    supportingLines: [
      'Insight without execution creates frustration.',
      'Digital Accelerators compress time-to-value, turning plans into action and learning into momentum.',
      'For new joiners: this shows how ideas turn into real outcomes.',
    ],
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-grow">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12">
              ...
              <FadeInUpOnScroll>
                ...
                <p className="text-lg md:text-xl text-white/95 mb-8 font-normal leading-relaxed text-left max-w-3xl" style={{ fontFamily: 'Inter, system-ui, -apple-system, sans-serif' }}>
                  At DQ, change is designed, built, and delivered deliberately — not left to chance.
                  <br />
                  Agile 6xD is how we turn ambition into execution, and strategy into real work.
                </p>
              </FadeInUpOnScroll>
        ...
        <section className="py-14 md:py-16 bg-white">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 max-w-5xl">
            <FadeInUpOnScroll>
              <div className="space-y-6 text-left">
                <p className="text-lg md:text-xl text-[#030F35] leading-relaxed">
                  As a new joiner, you’ll hear the word transformation often. At DQ, transformation isn’t a slogan — it’s a system. Agile 6xD is the shared language we use to design, deliver, and scale change across teams, products, and organisations. It explains how work moves from ideas to outcomes — and how your role connects to that flow.
                </p>
                <p className="text-lg md:text-xl text-[#030F35] leading-relaxed">
                  Most organisations treat transformation as a project — a roadmap, a deadline, a finish line. At DQ, transformation is normal work. Agile 6xD is the operating system that allows change to happen continuously, with clarity, structure, and rhythm — even as priorities shift. It helps teams move fast without losing direction.
                </p>
              </div>
            </FadeInUpOnScroll>
          </div>
        ...
        {/* CLOSING NOTE */}
        <section className="py-14 md:py-16 bg-[#F7FAFF]">
          <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-12 max-w-5xl">
            <FadeInUpOnScroll>
              <p className="text-lg md:text-xl text-[#030F35] leading-relaxed">
                You don’t need to master all six perspectives on day one. Over time, you’ll encounter them through projects, decisions, tools, and everyday work inside the DQ Digital Workspace. Agile 6xD gives everyone a shared frame of reference — so even as work changes, the way we build change stays consistent.
              </p>
            </FadeInUpOnScroll>
          </div>
        </section>
