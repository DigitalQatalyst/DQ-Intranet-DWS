...
const associateTestimonialsData = [
  ...
  },
  {
    ...
    quote:
      "DigitalQatalyst's values has helped me focus on creating real impact, not just completing tasks. It has encouraged me to take ownership and think clearly about outcomes. Values like accountability, collaboration, and continuous learning have supported my growth. This has helped me become more confident and responsible in my role and as an individual."
  },
  {
    id: "sharon-adhiambo",
        ...
        <nav className="flex mb-4" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2">
            ...
            <li aria-current="page">
              <div className="flex items-center">
                <ChevronRightIcon size={16} className="text-gray-400" />
                <span className="ml-1 text-gray-500 md:ml-2">Associate Feedback</span>
              </div>
            </li>
          </ol>
        </nav>
      ...
      <div className="w-full bg-gray-900">
        <div className="relative w-full h-80 md:h-[420px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col justify-center px-4 md:px-6 lg:px-8 text-white max-w-full">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-4 leading-tight">Associate Feedback</h1>
        ...
        <div className="mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {associateTestimonialsData.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-gray-50 border border-gray-200 rounded-2xl shadow-sm p-4 md:p-5 flex flex-col gap-4 hover:shadow-md transition-shadow"
              >
                ...
                <div className="flex items-center gap-3 pt-1">
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-600">
                  ...
                  <div className="leading-tight">
                    ...
                    <p className="text-[11px] text-gray-500">{testimonial.organization}</p>
                  </div>
                </div>
              </div>
            ))}
