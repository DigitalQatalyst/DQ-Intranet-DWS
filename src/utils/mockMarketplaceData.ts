...
export const mockNonFinancialServices = [
  ...
  },
  {
    ...
    provider: {
      ...
      logoUrl: '/DWS-Logo.png',
      description:
        'DQ HR Support handles human resources requests including staff requisitions, hiring, and employee management.',
    },
    ...
    details: [
      ...
      'Track hiring process status',
    ],
    tags: ['HR', 'Hybrid', 'Business'],
  ...
  },
  {
    ...
    details: [
      ...
      'Complete employee onboarding processes',
    ],
    tags: ['HR', 'In person', 'Business'],
    featuredImageUrl: '/images/services/registration.jpg',
  },
  {
    id: '7',
  ...
  },
  {
    ...
    tags: ['finance', 'Online', 'Business'],
    featuredImageUrl: '/images/services/governance.jpg',
  },
  {
    id: '9',
    title: 'Proposal',
    ...
    details: [
      ...
      'Create comprehensive proposal reports',
    ],
    tags: ['finance', 'Online', 'Business'],
    featuredImageUrl: '/images/services/proposal.jpg',
  },
  {
    id: '10',
    title: 'Cursor AI',
    ...
    aiProducts: ['AI IDEs'],
    integrations: ['REST APIs', 'Plugins'],
    provider: {
    ...
    tags: ['Digital Innovation', 'Online', 'Digital Worker'],
  ...
  },
  {
    ...
    dwServiceType: ['AI Tool Access'],
    usageGuidelines: ['Policies', 'Best Practices'],
    aiProducts: ['low_code_tools'],
    integrations: ['REST APIs', 'GraphQL APIs', 'SDKs'],
    provider: {
      name: 'Digital Innovation',
