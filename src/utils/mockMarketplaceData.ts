...
export const mockNonFinancialServices = [
  ...
  },
  {
    ...
    description:
      'Submit a request to work from home for a specific period. DQ supports flexible work arrangements to promote work-life balance while maintaining productivity and team collaboration. Associates can request work-from-home arrangements for valid reasons including personal circumstances, health considerations, or improved focus time.',
    category: 'Employee Services',
    serviceType: 'Requisition',
    deliveryMode: 'Online',
    businessStage: 'All Stages',
    ...
    provider: {
      ...
      logoUrl: '/DWS-Logo.png',
      description:
        'DQ Human Resources manages work-from-home requests to ensure fair application of flexible work policies while maintaining operational effectiveness and team cohesion.',
    },
    duration: '1-2 business days',
    price: 'Free',
    details: [
      'Submit work-from-home request with valid justification',
      'Specify dates and duration of remote work arrangement',
      'Line manager approval required before implementation',
      'Must maintain regular working hours and availability',
      'Ensure stable internet connection and appropriate workspace',
      'Comply with company data security and confidentiality policies',
    ],
    tags: ['HR', 'Online', 'Business'],
    featuredImageUrl: '/images/services/work-from-home.jpg',
    requestUrl: 'https://teams.microsoft.com/l/app/7c316234-ded0-4f95-8a83-8453d0876592?source=app-bar-share-entrypoint',
  },
  {
    id: 'dw-001',
