    ...
    content: {
      subsections: [
        ...
        },
        {
          ...
          content:
            'Across DQ, video is created to do more than explain—it is used to persuade, inspire, teach, and build trust. V.DS is for the Associates responsible for making that happen. It serves scriptwriters shaping narratives, designers and editors crafting visual rhythm and emotion, marketers planning reach and performance, reviewers safeguarding quality, and leaders accountable for brand integrity. Whether a team is producing an onboarding film, a learning module, a thought-leadership explainer, or a campaign asset, V.DS is the shared system that brings all contributors onto the same creative and operational path. It ensures that regardless of unit or purpose—Marketing, HRA, DTMA, or DQ Stories—every team works from a common blueprint for video excellence.'
        },
        {
          id: 'problem',
          title: 'What problem does it solve for them?',
          content:
            'Before V.DS, video production often relied on individual talent, isolated workflows, and informal standards. Quality varied from one piece to another, storytelling lacked cohesion, and teams spent time correcting misalignment rather than strengthening impact. V.DS changes this by transforming video creation into a structured, end-to-end system. It replaces fragmented production routines with a shared framework that guides intent, narrative, design, review, and distribution. By embedding cinematic standards, clear roles, and measurable outcomes into every stage, V.DS removes uncertainty, reduces rework, and makes excellence repeatable rather than accidental. The result is video content that consistently delivers clarity, emotional resonance, and brand authority—allowing teams to focus less on how to make a video work, and more on how to make it matter.'
        },
        {
          id: '1.1',
        ...
        },
        {
          ...
          content: 'Stage 01 inaugurates the video item production through clarifying vision, scope, and preparation. It ensures every video begins with clear intent, visual direction, and measurable impact. This stage sets the creative and technical foundation for delivering high-quality, cinematic outputs that embody DQ’s brand excellence and storytelling standards.'
        },
        {
          id: '3.1',
        ...
        },
        {
          ...
          content: 'The Production Canvas ensures that every content item is aligned with DQ’s intellectual architecture and production standards. The canvas captures key validations, including: Alignment with DQ frameworks (e.g., D6, DBP, DT2.0); coherence with the overarching narrative structure and transformation storyline; clear artefact classification (e.g., Onboarding Video, Promo, Event Highlights); production scope, ownership, and timeline mapping. By formalizing this validation step, the canvas helps content teams avoid misalignment, clarify expectations, and accelerate production readiness with confidence and shared understanding.'
        },
        {
          id: '3.9',
        ...
        },
        {
          ...
          content: 'This section focuses on storyboarding, the process of visually mapping a completed script into a sequence of scenes. It bridges narrative and production, enabling teams to visualize transitions, emotions, and technical elements before filming or AI generation begins. Storyboarding ensures creative alignment and production efficiency, serving as the critical bridge between storytelling intent and on-screen execution.'
        },
        {
          id: '6.1',
