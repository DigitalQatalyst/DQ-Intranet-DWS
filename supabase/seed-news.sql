...
-- NOTE: This seed currently includes example entries. To fully mirror
-- src/data/media/news.ts, extend this file by following the same pattern
-- for all remaining NEWS items.
